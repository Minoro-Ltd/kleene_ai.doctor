...
export declare type FlowContent = Blockquote | Code | Heading | HTML | List | Image | ImageReference | ThematicBreak | Content | Table;
...
export declare type StaticPhrasingContent = Image | Break | Emphasis | HTML | ImageReference | InlineCode | Strong | Text | Delete;
